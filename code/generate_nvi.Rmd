...
header_toxpi <- read.csv("data/processed/toxpi/toxpi_header.csv", header = F, colClasses = rep("character",62))
# NYC Counties
...
```{r, export_features}
export(toxpi_export, "data/processed/nvi_features.csv", col.names = FALSE)
```
...
### 8: Importing the Index Generated from the ToxPi GUI
